...
Transaction::Transaction(double amount, QString type, QString category, QDate date, QString currency, bool recurring)
    : amount(amount), type(type), category(category), date(date), currency(currency), recurring(recurring) {}
